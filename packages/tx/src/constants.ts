...
export const FIELD_ELEMENTS_PER_BLOB = 4096 // This is also in the GlobalConfig 4844 parameters but needed here since types can't access GlobalConfig params
