...
export const FIELD_ELEMENTS_PER_BLOB = 4096 // This is also in the HardforkManager 4844 parameters but needed here since types can't access HardforkManager params
