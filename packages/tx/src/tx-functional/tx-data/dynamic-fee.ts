...
/**
 * Dynamic Fee transaction data (EIP-1559).
 * Implements the TxData interface for EIP-1559 transactions.
 */
export class DynamicFeeTxData implements TxData {
  ...
  txType(): number {
    return TxType.FeeMarketEIP1559
  }
  ...
  sigHash(chainID: bigint | undefined): Uint8Array {
    ...
    const typedMessage = [TxType.FeeMarketEIP1559, RLP.encode(message)]
