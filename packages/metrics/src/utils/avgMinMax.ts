 ...
 */
export class AvgMinMax<Labels extends LabelsGeneric>
  implements IAvgMinMax<Labels>
{
  ...
  constructor(configuration: GaugeConfiguration<LabelKeys<Labels>>) {
    this.sum = new GaugeExtra({
      ...configuration,
      name: `${configuration.name}_sum`,
    })
    this.avg = new GaugeExtra({
      ...configuration,
      name: `${configuration.name}_avg`,
    })
    this.min = new GaugeExtra({
      ...configuration,
      name: `${configuration.name}_min`,
    })
    this.max = new GaugeExtra({
      ...configuration,
      name: `${configuration.name}_max`,
    })
  }
