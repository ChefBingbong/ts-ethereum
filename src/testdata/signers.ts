...
export const SIGNER_C: Signer = {
	address: new Address(
		hexToBytes("0x83c30730d1972baa09765a1ac72a43db27fedce5"),
	),
	privateKey: hexToBytes(
		"0xf216ddcf276079043c52b5dd144aa073e6b272ad4bfeaf4fbbc044aa478d1927",
	),
	publicKey: hexToBytes(
...
export const SIGNER_D: Signer = {
	address: new Address(
		hexToBytes("0x8458f408106c4875c96679f3f556a511beabe138"),
	),
	privateKey: hexToBytes(
		"0x159e95d07a6c64ddbafa6036cdb7b8114e6e8cdc449ca4b0468a6d0c955f991b",
	),
	publicKey: hexToBytes(
...
export const SIGNER_E: Signer = {
	address: new Address(
		hexToBytes("0xab80a948c661aa32d09952d2a6c4ad77a4c947be"),
	),
	privateKey: hexToBytes(
		"0x48ec5a6c4a7fc67b10a9d4c8a8f594a81ae42e41ed061fa5218d96abb6012344",
	),
	publicKey: hexToBytes(
...
export const SIGNER_F: Signer = {
	address: new Address(
		hexToBytes("0xdc7bc81ddf67d037d7439f8e6ff12f3d2a100f71"),
	),
	privateKey: hexToBytes(
		"0x86b0ff7b6cf70786f29f297c57562905ab0b6c32d69e177a46491e56da9e486e",
	),
	publicKey: hexToBytes(
...
export const SIGNER_G: Signer = {
	address: new Address(
		hexToBytes("0xbe862ad9abfe6f22bcb087716c7d89a26051f74c"),
	),
	privateKey: hexToBytes(
...
export const SIGNER_H: Signer = {
	address: new Address(
		hexToBytes("0x610adc49ecd66cbf176a8247ebd59096c031bd9f"),
	),
	privateKey: hexToBytes(
